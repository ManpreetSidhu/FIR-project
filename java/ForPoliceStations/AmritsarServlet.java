 ...
 * @author sidhu
 */
public class AmritsarServlet extends HttpServlet {
    ...
    Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        ...
        PreparedStatement ps=con.prepareStatement
                ("update amritsar_ps set Officer_name=?,Rank=?,Status=? where Fir_no=?");
       ...
       if(i>0)
       {
           ...
           response.sendRedirect("amspolice.jsp?chk=invaid");
        } finally {            
            out.close();
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AmritsarServlet.class.getName()).log(Level.SEVERE, null, ex);
