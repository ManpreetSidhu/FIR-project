 ...
 * @author sidhu
 */
public class BarnalaServlet extends HttpServlet {
    ...
    Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        ...
        PreparedStatement ps=con.prepareStatement
                ("update barnala_ps set Officer_name=?,Rank=?,Status=? where Fir_no=?");
       ...
       if(i>0)
       {
           ...
           response.sendRedirect("barpolice.jsp?chk=invalid");
        } 
        catch(Exception e)
        {
